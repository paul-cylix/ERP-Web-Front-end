      ...
      <div class="card-body pt-0">
        ...
        <div class="row mt-4" v-else-if="this.counter === 1">
          ...
          <div class="mx-2 table-responsive">
            <table
              class="
                table table-sm table-bordered table-striped table-responsive
                text-nowrap
                m-0
              "
            >
              <thead>
                <tr>
                  <th colspan="8" scope="col">
                    <aside class="d-flex align-items-center">
                      <span class="mb-1 ml-1"> Overtime Table Template</span>
                    </aside>
                  </th>
    ...
    validateSaveDraft(){
      if(this.missingOTData && this.missingReportingManager){
          this.openToast(
            "top-right",
            "warning",
            "Reporting Manager and OT Data is required"
          );
          this.$refs.refSaveDraftCloseBtn.click();
      } else if (this.missingOTData ){
          this.openToast(
            "top-right",
            "warning",
            "Overtime Data is required"
          );
          this.$refs.refSaveDraftCloseBtn.click();
      } else if (this.missingReportingManager){
        this.openToast(
            "top-right",
            "warning",
